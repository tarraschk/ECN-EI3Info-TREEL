...
static bool recevoir_caractere_serie1_ex7 (uint8 * outCaractere) {
...
static void reporter_entrees (void) {
  ...
  if (recevoir_caractere_serie1_ex7 (& nouvellesEntrees)) {
